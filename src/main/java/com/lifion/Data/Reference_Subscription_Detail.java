...
public class Reference_Subscription_Detail implements Serializable {
	...
	//bi-directional many-to-one association to Reference_Content_Limitation
	@ManyToOne
	@JoinColumn(name="Content_Providers")
	private Reference_Content_Limitation referenceContentLimitation;
	...
	public Reference_Content_Limitation getReferenceContentLimitation() {
		return this.referenceContentLimitation;
	}

	public void setReferenceContentLimitation(Reference_Content_Limitation referenceContentLimitation) {
		this.referenceContentLimitation = referenceContentLimitation;
	}
